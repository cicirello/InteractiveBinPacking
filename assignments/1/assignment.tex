% Copyright 2021-2026 Vincent A. Cicirello
%
...
You do not need a Java JDK as we will not be compiling the Java program. 
Only a Java Runtime Environment (JRE) is needed. See the GitHub repository
for the specific Java version required for the version of the application
that you are using: \url{https://github.com/cicirello/InteractiveBinPacking#java-requirements}.
...
a Java Runtime Environment (JRE). Since we will
...
application. For information on the minimum version of Java required for the
version you are using of Interactive Bin Packing, see the GitHub repository:
\url{https://github.com/cicirello/InteractiveBinPacking#java-requirements}.
