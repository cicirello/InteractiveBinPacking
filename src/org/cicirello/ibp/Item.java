...
/**
 * This class represents a single object for the
 * bin packing problem (i.e., an object that must
 * be packed into one of the bins).
 * 
...
public class Item {
	 ...
	 * @param size The size of the item (i.e., number of units of bin 
	 * capacity needed by the item).
	...
	/**
	 * Gets the size of the item (i.e., number of units of bin 
	 * capacity needed by the item).
