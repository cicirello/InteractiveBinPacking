...
/**
 * This class implements the bottom panel of the UI, which 
...
public class BottomPanel extends JPanel {
	 ...
	 * @param state The state of the bins, which objects are in which bins, and other
	 * application state data such as the mode the application is in.
