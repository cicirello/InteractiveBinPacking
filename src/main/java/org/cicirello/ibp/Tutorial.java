...
/**
 * This class implements the Tutorial dialog, which displays explanations of the heuristics, the
 * problem itself, and suggests a sequence of steps to take using the application to practice with
 * the various heuristics.
 *
 * @author <a href=https://www.cicirello.org/ target=_top>Vincent A. Cicirello</a>, <a
 *     href=https://www.cicirello.org/ target=_top>https://www.cicirello.org/</a>
 */
final class Tutorial extends InfoDialog {
