...
public final class SessionLog implements Serializable {
  ...
  static final class SessionLogFormatter {
    ...
    private SessionLogFormatter(RecordList records, int[] successfulMoves, int[] failedMoves) {
    ...
    boolean checkInstance(
        int[] sizes, String[] items, String instance, ArrayList<String> alertList) {
