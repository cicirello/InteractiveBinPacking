...
class Bin {
  ...
  /**
   * Checks whether the bin has sufficient remaining space for a new item to fit.
   *
   ...
   *
   * @param decreasing If true, then sorts from largest to smallest. Otherwise, sorts from smallest
   *     to largest.
   */
