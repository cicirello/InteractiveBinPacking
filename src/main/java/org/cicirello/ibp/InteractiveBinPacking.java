...
/**
 * This class implements the frame holding the application, and is also the entry point to the
 * application, containing the main method. It handles everything needed to start up the app.
 *
